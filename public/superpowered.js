var SuperpoweredModule = (function () {
  ...
  return function (SuperpoweredModule) {
    ...
    Module["createAudioNode"] = function (
      ...
      console.log("DBG createAudioNode");
      if (typeof AudioWorkletNode === "function") {
        console.log("DBG in if");
        ...
        audioContext.audioWorklet
          ...
          .catch((error) => {
            console.log("DBG in ERROR");
            console.log("error", error);
          });
      } else {
        console.log("DBG in else");
        import(url).then((processorModule) => {
          ...
          node.processor = new processorModule.default(this);
